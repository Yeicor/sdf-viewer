...
use three_d::{lights_shader_source, Blend, ColorMapping, Cull, EffectMaterialId, Light, Material, MaterialType, RenderStates, Srgba, Texture3D, ToneMapping, Viewer};
...
impl Material for SDFViewerMaterial {
    ...
    fn use_uniforms(
        ...
        program.use_uniform("lightingModel", 2);
...
fn bvp_matrix(camera: &dyn Viewer) -> three_d::Mat4 {
